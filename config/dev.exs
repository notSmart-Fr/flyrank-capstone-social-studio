...
config :flyrank_capstone_social_studio, FlyrankCapstoneSocialStudioWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "BCf9z6o8zBtblYmbrO08VS6egCSY51hPBepKVptkf05GswRB/KshY2xCBli83rij",
  watchers: [
    esbuild:
      {Esbuild, :install_and_run,
       [:flyrank_capstone_social_studio, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:flyrank_capstone_social_studio, ~w(--watch)]}
  ]
...
config :flyrank_capstone_social_studio, dev_routes: true
