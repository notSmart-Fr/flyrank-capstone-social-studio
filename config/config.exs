...
config :flyrank_capstone_social_studio, FlyrankCapstoneSocialStudioWeb.Endpoint,
  ...
  pubsub_server: FlyrankCapstoneSocialStudio.PubSub,
  live_view: [signing_salt: "HaFSCDMD"]
...
# Configure publishing adapters for the platform.
config :flyrank_capstone_social_studio, :adapters,
